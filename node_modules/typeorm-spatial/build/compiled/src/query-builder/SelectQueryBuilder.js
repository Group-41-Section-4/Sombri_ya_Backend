        ...
        if (Object.keys(orderBys).length > 0)
            return " ORDER BY " + Object.keys(orderBys)
                ...
                if (typeof orderBys[columnName] === "string") {
                    ...
                    if (!!orderBys[columnName].distance) {
                        var geoJsonString = JSON.stringify(orderBys[columnName].distance);
                        return "ST_Distance(" + _this.replacePropertyNames(columnName) + ", ST_GeomFromGeoJSON('" + geoJsonString +
